...
def gerar_dataset_de_teste(quantidade=5):
    ...
    logger.info(f"Gerando {quantidade} perguntas baseadas nos documentos...\n")
    ...
    for idx in indices_sorteados:
        ...
        try:
            ...
            logger.info(f"✅ Pergunta gerada para a fonte: {qa_pair['fonte']}")
            
        except Exception as e:
            logger.error(f"Erro ao gerar pergunta para um chunk: {e}")
